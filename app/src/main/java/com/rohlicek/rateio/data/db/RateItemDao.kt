...
""")
    ...
    @Query("UPDATE rate_items SET ratingWeight = :weight, updatedAt = :now WHERE id = :id")
    suspend fun updateWeight(id: Long, weight: Float?, now: Long = System.currentTimeMillis())
